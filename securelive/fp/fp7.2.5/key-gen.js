...
function generate_key(domain) {
   ...
   for (var i = domain.length - 1; i >= 0; i--) {
      sum1 += domain.charCodeAt(i) * 234972528074448273;
      sum2 += domain.charCodeAt(i) * 595572250180106850;
   }
